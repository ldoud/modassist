...
public abstract class PrimaryStatNameBaseTest {
    ...
    protected abstract void assertPrimaryStat(CharacterName toon, ModType modType, StatName primaryStatName, String expectedStatValue);
}
